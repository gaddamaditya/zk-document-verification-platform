...
export default function Home() {
  ...
  return (
    <div className="space-y-16 pb-20 max-w-5xl mx-auto">
      {/* ── Main Hero ────────────────────────────────────────── */}
      <section className="text-center space-y-6 pt-4 pb-10 border-b border-border">
        <motion.div
        ...
        >
          Prove claims about your documents without revealing the documents themselves.
        </motion.h1>
        ...
        >
          <Button
            ...
            className="w-full sm:w-auto bg-teal-600 hover:bg-teal-700 text-white dark:bg-teal-500 dark:hover:bg-teal-600 px-8 py-3 font-semibold shadow-xs"
          >
            Prove a Claim
          </Button>
      ...
      {/* ── Privacy & Trust ──────────────────────────────────── */}
      <section className="rounded-2xl border border-border bg-card p-8 md:p-10 space-y-4 shadow-xs">
